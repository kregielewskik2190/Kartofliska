...
<body>
	<div class="container">
		...
		<div class="container__panel">
			<button id="toggleMeetings" class="container__nav-buttons">Spotkania</button>
		...
		<div class="container__box container__box--hidden container__box--stadiums" id="stadiums">
			<div class="container__controls">
				...
				<!-- <div class="container__control">
					<label for="stadiony_nazwa">Nazwa stadionu</label>
					<input type="number" name="stadiony_nazwa" id="stadiony_nazwa" min="10" max="50" step="10" value="20">
				</div> -->
			</div>
			...
			<div class="container__table" id="stadiony_table">
				...
				<?php
					echo join("\n",array_map(function($stadion) use ($druzyny) {
						$druzyna = $druzyny[(int) $stadion['druzyna_id']];
						return "<div class=\"container__row\">
